...
sed -i "s/AUTO_SETUP_NET_USESTATIC=0/AUTO_SETUP_NET_USESTATIC=1/g" /mnt/dietpi.txt
sed -i "s/AUTO_SETUP_NET_WIFI_COUNTRY_CODE=NL/AUTO_SETUP_NET_WIFI_COUNTRY_CODE=NL/g" /mnt/dietpi.txt
sed -i "s/AUTO_SETUP_SSH_SERVER_INDEX=1/AUTO_SETUP_SSH_SERVER_INDEX=2/g" /mnt/dietpi.txt
sed -i "s/AUTO_SETUP_SWAPFILE_SIZE=1/AUTO_SETUP_SWAPFILE_SIZE=0/g" /mnt/dietpi.txt
sed -i "s/CONFIG_CPU_DISABLE_TURBO=0/CONFIG_CPU_DISABLE_TURBO=1/g" /mnt/dietpi.txt
sed -i "s/CONFIG_CPU_GOVERNOR=schedutil/CONFIG_CPU_GOVERNOR=powersave/g" /mnt/dietpi.txt
sed -i "s/SOFTWARE_DISABLE_SSH_PASSWORD_LOGINS=0/SOFTWARE_DISABLE_SSH_PASSWORD_LOGINS=1/g" /mnt/dietpi.txt
sed -i "s|AUTO_SETUP_TIMEZONE=Europe/London|AUTO_SETUP_TIMEZONE=Europe/Amsterdam|g" /mnt/dietpi.txt
echo "AUTO_SETUP_SSH_PUBKEY=$(cat $HOME/.ssh/id_ed25519.pub)" >> /mnt/dietpi.txt
